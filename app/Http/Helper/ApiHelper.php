...
class ApiHelper {
    ...
    */
    public static 
    function appendUrlWithQueryParameters($queryBuilder, $parameters)
    {
    ...
    */
    public static 
    function appendUrlWithTemplateParameters($url, $parameters)
    {
        //perform parameter validation
    ...
    public static 
    function build_post_data($boundary, $fields, $files){
        $data = '';
        $eol = "\r\n";
    ...
    */
    public static 
    function set_headers(array $headers, $header_key, $header_value) 
    {
    ...
    */
    public static 
    function make_api_call(string $method, string $request_url, array $url_params=null, array $post_params=null, array $file_params=null) 
    {
        $headers = array();
